...
export const graph = {
    ...
    j1: {
        ...
        a3: calcCost(1, 3), b3: calcCost(1, 3), c3: calcCost(1, 3), d3: calcCost(1, 3), e3: calcCost(1, 3), f3: calcCost(1, 3), g3: calcCost(1, 3), h3: calcCost(1, 3), i3: calcCost(1, 3), k3: calcCost(1, 3), l3: calcCost(1, 3), // 1->3 
        a4: calcCost(1, 4), b4: calcCost(1, 4), c4: calcCost(1, 4), d4: calcCost(1, 4), e4: calcCost(1, 4), f4: calcCost(1, 4), g4: calcCost(1, 4), h4: calcCost(1, 4), i4: calcCost(1, 4), k4: calcCost(1, 4), l4: calcCost(1, 4), // 1->4         
        a5: calcCost(1, 5), b5: calcCost(1, 5), c5: calcCost(1, 5), d5: calcCost(1, 5), e5: calcCost(1, 5), f5: calcCost(1, 5), g5: calcCost(1, 5), h5: calcCost(1, 5), i5: calcCost(1, 5), k5: calcCost(1, 5), l5: calcCost(1, 5), // 1->5
        a6: calcCost(1, 6), b6: calcCost(1, 6), c6: calcCost(1, 6), d6: calcCost(1, 6), e6: calcCost(1, 6), f6: calcCost(1, 6), g6: calcCost(1, 6), h6: calcCost(1, 6), i6: calcCost(1, 6), k6: calcCost(1, 6), l6: calcCost(1, 6), // 1->6
    },
    k1: {
    ...
    l1: {
        ...
        a3: calcCost(1, 3), b3: calcCost(1, 3), c3: calcCost(1, 3), d3: calcCost(1, 3), e3: calcCost(1, 3), f3: calcCost(1, 3), g3: calcCost(1, 3), h3: calcCost(1, 3), i3: calcCost(1, 3), j3: calcCost(1, 3), k3: calcCost(1, 3), // 1->3 
        a4: calcCost(1, 4), b4: calcCost(1, 4), c4: calcCost(1, 4), d4: calcCost(1, 4), e4: calcCost(1, 4), f4: calcCost(1, 4), g4: calcCost(1, 4), h4: calcCost(1, 4), i4: calcCost(1, 4), j4: calcCost(1, 4), k4: calcCost(1, 4), // 1->4         
        a5: calcCost(1, 5), b5: calcCost(1, 5), c5: calcCost(1, 5), d5: calcCost(1, 5), e5: calcCost(1, 5), f5: calcCost(1, 5), g5: calcCost(1, 5), h5: calcCost(1, 5), i5: calcCost(1, 5), j5: calcCost(1, 5), k5: calcCost(1, 5), // 1->5
        a6: calcCost(1, 6), b6: calcCost(1, 6), c6: calcCost(1, 6), d6: calcCost(1, 6), e6: calcCost(1, 6), f6: calcCost(1, 6), g6: calcCost(1, 6), h6: calcCost(1, 6), i6: calcCost(1, 6), j6: calcCost(1, 6), k6: calcCost(1, 6), // 1->6
    },
    a2: {
    ...
    j2: {
        a3: calcCost(2, 3), b3: calcCost(2, 3), c3: calcCost(2, 3), d3: calcCost(2, 3), e3: calcCost(2, 3), f3: calcCost(2, 3), g3: calcCost(2, 3), h3: calcCost(2, 3), i3: calcCost(2, 3), k3: calcCost(2, 3), l3: calcCost(2, 3), // 2->3
        a4: calcCost(2, 4), b4: calcCost(2, 4), c4: calcCost(2, 4), d4: calcCost(2, 4), e4: calcCost(2, 4), f4: calcCost(2, 4), g4: calcCost(2, 4), h4: calcCost(2, 4), i4: calcCost(2, 4), k4: calcCost(2, 4), l4: calcCost(2, 4), // 2->4 
        a5: calcCost(2, 5), b5: calcCost(2, 5), c5: calcCost(2, 5), d5: calcCost(2, 5), e5: calcCost(2, 5), f5: calcCost(2, 5), g5: calcCost(2, 5), h5: calcCost(2, 5), i5: calcCost(2, 5), k5: calcCost(2, 5), l5: calcCost(2, 5), // 2->5         
        a6: calcCost(2, 6), b6: calcCost(2, 6), c6: calcCost(2, 6), d6: calcCost(2, 6), e6: calcCost(2, 6), f6: calcCost(2, 6), g6: calcCost(2, 6), h6: calcCost(2, 6), i6: calcCost(2, 6), k6: calcCost(2, 6), l6: calcCost(2, 6), // 2->6
        a7: calcCost(2, 7), b7: calcCost(2, 7), c7: calcCost(2, 7), d7: calcCost(2, 7), e7: calcCost(2, 7), f7: calcCost(2, 7), g7: calcCost(2, 7), h7: calcCost(2, 7), i7: calcCost(2, 7), k7: calcCost(2, 7), l7: calcCost(2, 7), // 2->7
    },
    k2: {
    ...
    l2: {
        a3: calcCost(2, 3), b3: calcCost(2, 3), c3: calcCost(2, 3), d3: calcCost(2, 3), e3: calcCost(2, 3), f3: calcCost(2, 3), g3: calcCost(2, 3), h3: calcCost(2, 3), i3: calcCost(2, 3), j3: calcCost(2, 3), k3: calcCost(2, 3),  // 2->3
        a4: calcCost(2, 4), b4: calcCost(2, 4), c4: calcCost(2, 4), d4: calcCost(2, 4), e4: calcCost(2, 4), f4: calcCost(2, 4), g4: calcCost(2, 4), h4: calcCost(2, 4), i4: calcCost(2, 4), j4: calcCost(2, 4), k4: calcCost(2, 4),  // 2->4 
        a5: calcCost(2, 5), b5: calcCost(2, 5), c5: calcCost(2, 5), d5: calcCost(2, 5), e5: calcCost(2, 5), f5: calcCost(2, 5), g5: calcCost(2, 5), h5: calcCost(2, 5), i5: calcCost(2, 5), j5: calcCost(2, 5), k5: calcCost(2, 5),  // 2->5         
        a6: calcCost(2, 6), b6: calcCost(2, 6), c6: calcCost(2, 6), d6: calcCost(2, 6), e6: calcCost(2, 6), f6: calcCost(2, 6), g6: calcCost(2, 6), h6: calcCost(2, 6), i6: calcCost(2, 6), j6: calcCost(2, 6), k6: calcCost(2, 6),  // 2->6
        a7: calcCost(2, 7), b7: calcCost(2, 7), c7: calcCost(2, 7), d7: calcCost(2, 7), e7: calcCost(2, 7), f7: calcCost(2, 7), g7: calcCost(2, 7), h7: calcCost(2, 7), i7: calcCost(2, 7), j7: calcCost(2, 7), k7: calcCost(2, 7),  // 2->7
    },
    a3: {
        a3: calcCost(3, 3), b3: calcCost(3, 3), c3: calcCost(3, 3), d3: calcCost(3, 3), e3: calcCost(3, 3), f3: calcCost(3, 3), g3: calcCost(3, 3), h3: calcCost(3, 3), i3: calcCost(3, 3), k3: calcCost(3, 3), // 3->3
    ...
    j3: {
        ...
        a4: calcCost(3, 4), b4: calcCost(3, 4), c4: calcCost(3, 4), d4: calcCost(3, 4), e4: calcCost(3, 4), f4: calcCost(3, 4), g4: calcCost(3, 4), h4: calcCost(3, 4), i4: calcCost(3, 4), k4: calcCost(3, 4), l4: calcCost(3, 4), // 3->4 
        a5: calcCost(3, 5), b5: calcCost(3, 5), c5: calcCost(3, 5), d5: calcCost(3, 5), e5: calcCost(3, 5), f5: calcCost(3, 5), g5: calcCost(3, 5), h5: calcCost(3, 5), i5: calcCost(3, 5), k5: calcCost(3, 5), l5: calcCost(3, 5), // 3->5         
        a6: calcCost(3, 6), b6: calcCost(3, 6), c6: calcCost(3, 6), d6: calcCost(3, 6), e6: calcCost(3, 6), f6: calcCost(3, 6), g6: calcCost(3, 6), h6: calcCost(3, 6), i6: calcCost(3, 6), k6: calcCost(3, 6), l6: calcCost(3, 6), // 3->6
        a7: calcCost(3, 7), b7: calcCost(3, 7), c7: calcCost(3, 7), d7: calcCost(3, 7), e7: calcCost(3, 7), f7: calcCost(3, 7), g7: calcCost(3, 7), h7: calcCost(3, 7), i7: calcCost(3, 7), k7: calcCost(3, 7), l7: calcCost(3, 7), // 3->7
    },
    k3: {
        j3: calcCost(3, 3), k3: calcCost(3, 3), l3: calcCost(3, 3), // 3->3
    ...
    l3: {
        ...
        a4: calcCost(3, 4), b4: calcCost(3, 4), c4: calcCost(3, 4), d4: calcCost(3, 4), e4: calcCost(3, 4), f4: calcCost(3, 4), g4: calcCost(3, 4), h4: calcCost(3, 4), i4: calcCost(3, 4), j4: calcCost(3, 4), k4: calcCost(3, 4),  // 3->4 
        a5: calcCost(3, 5), b5: calcCost(3, 5), c5: calcCost(3, 5), d5: calcCost(3, 5), e5: calcCost(3, 5), f5: calcCost(3, 5), g5: calcCost(3, 5), h5: calcCost(3, 5), i5: calcCost(3, 5), j5: calcCost(3, 5), k5: calcCost(3, 5),  // 3->5         
        a6: calcCost(3, 6), b6: calcCost(3, 6), c6: calcCost(3, 6), d6: calcCost(3, 6), e6: calcCost(3, 6), f6: calcCost(3, 6), g6: calcCost(3, 6), h6: calcCost(3, 6), i6: calcCost(3, 6), j6: calcCost(3, 6), k6: calcCost(3, 6), // 3->6
        a7: calcCost(3, 7), b7: calcCost(3, 7), c7: calcCost(3, 7), d7: calcCost(3, 7), e7: calcCost(3, 7), f7: calcCost(3, 7), g7: calcCost(3, 7), h7: calcCost(3, 7), i7: calcCost(3, 7), j7: calcCost(3, 7), k7: calcCost(3, 7),  // 3->7
    },
    a4: {
        a4: calcCost(4, 4), b4: calcCost(4, 4), c4: calcCost(4, 4), d4: calcCost(4, 4), e4: calcCost(4, 4), f4: calcCost(4, 4), g4: calcCost(4, 4), h4: calcCost(4, 4), i4: calcCost(4, 4), k4: calcCost(4, 4), // 4->4
    ...
    j4: {
        ...
        a5: calcCost(4, 5), b5: calcCost(4, 5), c5: calcCost(4, 5), d5: calcCost(4, 5), e5: calcCost(4, 5), f5: calcCost(4, 5), g5: calcCost(4, 5), h5: calcCost(4, 5), i5: calcCost(4, 5), k5: calcCost(4, 5), l5: calcCost(4, 5), // 4->5 
        a6: calcCost(4, 6), b6: calcCost(4, 6), c6: calcCost(4, 6), d6: calcCost(4, 6), e6: calcCost(4, 6), f6: calcCost(4, 6), g6: calcCost(4, 6), h6: calcCost(4, 6), i6: calcCost(4, 6), k6: calcCost(4, 6), l6: calcCost(4, 6), // 4->6         
        a7: calcCost(4, 7), b7: calcCost(4, 7), c7: calcCost(4, 7), d7: calcCost(4, 7), e7: calcCost(4, 7), f7: calcCost(4, 7), g7: calcCost(4, 7), h7: calcCost(4, 7), i7: calcCost(4, 7), k7: calcCost(4, 7), l7: calcCost(4, 7), // 4->7
        a8: calcCost(4, 8), b8: calcCost(4, 8), c8: calcCost(4, 8), d8: calcCost(4, 8), e8: calcCost(4, 8), f8: calcCost(4, 8), g8: calcCost(4, 8), h8: calcCost(4, 8), i8: calcCost(4, 8), k8: calcCost(4, 8), l8: calcCost(4, 8), // 4->8
    },
    k4: {
        j4: calcCost(4, 4), k4: calcCost(4, 4), l4: calcCost(4, 4), // 4->4
    ...
    l4: {
        ...
        a5: calcCost(4, 5), b5: calcCost(4, 5), c5: calcCost(4, 5), d5: calcCost(4, 5), e5: calcCost(4, 5), f5: calcCost(4, 5), g5: calcCost(4, 5), h5: calcCost(4, 5), i5: calcCost(4, 5), j5: calcCost(4, 5), k5: calcCost(4, 5), // 4->5 
        a6: calcCost(4, 6), b6: calcCost(4, 6), c6: calcCost(4, 6), d6: calcCost(4, 6), e6: calcCost(4, 6), f6: calcCost(4, 6), g6: calcCost(4, 6), h6: calcCost(4, 6), i6: calcCost(4, 6), j6: calcCost(4, 6), k6: calcCost(4, 6), // 4->6         
        a7: calcCost(4, 7), b7: calcCost(4, 7), c7: calcCost(4, 7), d7: calcCost(4, 7), e7: calcCost(4, 7), f7: calcCost(4, 7), g7: calcCost(4, 7), h7: calcCost(4, 7), i7: calcCost(4, 7), j7: calcCost(4, 7), k7: calcCost(4, 7), // 4->7
        a8: calcCost(4, 8), b8: calcCost(4, 8), c8: calcCost(4, 8), d8: calcCost(4, 8), e8: calcCost(4, 8), f8: calcCost(4, 8), g8: calcCost(4, 8), h8: calcCost(4, 8), i8: calcCost(4, 8), j8: calcCost(4, 8), k8: calcCost(4, 8), // 4->8
    },
    a5: {
        ...
        a5: calcCost(5, 5), b5: calcCost(5, 5), c5: calcCost(5, 5), d5: calcCost(5, 5), e5: calcCost(5, 5), f5: calcCost(5, 5), g5: calcCost(5, 5), h5: calcCost(5, 5), i5: calcCost(5, 5), k5: calcCost(5, 5), // 5->5        
    ...
    j5: {
        a4: calcCost(5, 4), b4: calcCost(5, 4), c4: calcCost(5, 4), d4: calcCost(5, 4), e4: calcCost(5, 4), f4: calcCost(5, 4), g4: calcCost(5, 4), h4: calcCost(5, 4), i4: calcCost(5, 4), k4: calcCost(5, 4), l4: calcCost(5, 4), // 5->4
        ...
        a6: calcCost(5, 6), b6: calcCost(5, 6), c6: calcCost(5, 6), d6: calcCost(5, 6), e6: calcCost(5, 6), f6: calcCost(5, 6), g6: calcCost(5, 6), h6: calcCost(5, 6), i6: calcCost(5, 6), k6: calcCost(5, 6), l6: calcCost(5, 6), // 5->6         
        a7: calcCost(5, 7), b7: calcCost(5, 7), c7: calcCost(5, 7), d7: calcCost(5, 7), e7: calcCost(5, 7), f7: calcCost(5, 7), g7: calcCost(5, 7), h7: calcCost(5, 7), i7: calcCost(5, 7), k7: calcCost(5, 7), l7: calcCost(5, 7), // 5->7
        a8: calcCost(5, 8), b8: calcCost(5, 8), c8: calcCost(5, 8), d8: calcCost(5, 8), e8: calcCost(5, 8), f8: calcCost(5, 8), g8: calcCost(5, 8), h8: calcCost(5, 8), i8: calcCost(5, 8), k8: calcCost(5, 8), l8: calcCost(5, 8), // 5->8
    },
    k5: {
        j4: calcCost(5, 4), k4: calcCost(5, 4), l4: calcCost(5, 4), // 5->4
        j5: calcCost(5, 5), k5: calcCost(5, 5), l5: calcCost(5, 5), // 5->5 
    ...
    l5: {
        a4: calcCost(5, 4), b4: calcCost(5, 4), c4: calcCost(5, 4), d4: calcCost(5, 4), e4: calcCost(5, 4), f4: calcCost(5, 4), g4: calcCost(5, 4), h4: calcCost(5, 4), i4: calcCost(5, 4), j4: calcCost(5, 4), k4: calcCost(5, 4),  // 5->4
        ...
        a6: calcCost(5, 6), b6: calcCost(5, 6), c6: calcCost(5, 6), d6: calcCost(5, 6), e6: calcCost(5, 6), f6: calcCost(5, 6), g6: calcCost(5, 6), h6: calcCost(5, 6), i6: calcCost(5, 6), j6: calcCost(5, 6), k6: calcCost(5, 6),  // 5->6         
        a7: calcCost(5, 7), b7: calcCost(5, 7), c7: calcCost(5, 7), d7: calcCost(5, 7), e7: calcCost(5, 7), f7: calcCost(5, 7), g7: calcCost(5, 7), h7: calcCost(5, 7), i7: calcCost(5, 7), j7: calcCost(5, 7), k7: calcCost(5, 7),  // 5->7
        a8: calcCost(5, 8), b8: calcCost(5, 8), c8: calcCost(5, 8), d8: calcCost(5, 8), e8: calcCost(5, 8), f8: calcCost(5, 8), g8: calcCost(5, 8), h8: calcCost(5, 8), i8: calcCost(5, 8), j8: calcCost(5, 8), k8: calcCost(5, 8),  // 5->8
    },
    a6: {
        ...
        a6: calcCost(6, 6), b6: calcCost(6, 6), c6: calcCost(6, 6), d6: calcCost(6, 6), e6: calcCost(6, 6), f6: calcCost(6, 6), g6: calcCost(6, 6), h6: calcCost(6, 6), i6: calcCost(6, 6), k6: calcCost(6, 6), // 6->6        
    ...
    j6: {
        a5: calcCost(6, 5), b5: calcCost(6, 5), c5: calcCost(6, 5), d5: calcCost(6, 5), e5: calcCost(6, 5), f5: calcCost(6, 5), g5: calcCost(6, 5), h5: calcCost(6, 5), i5: calcCost(6, 5), k5: calcCost(6, 5), l5: calcCost(6, 5), // 6->5
        ...
        a7: calcCost(6, 7), b7: calcCost(6, 7), c7: calcCost(6, 7), d7: calcCost(6, 7), e7: calcCost(6, 7), f7: calcCost(6, 7), g7: calcCost(6, 7), h7: calcCost(6, 7), i7: calcCost(6, 7), k7: calcCost(6, 7), l7: calcCost(6, 7), // 6->7         
        a8: calcCost(6, 8), b8: calcCost(6, 8), c8: calcCost(6, 8), d8: calcCost(6, 8), e8: calcCost(6, 8), f8: calcCost(6, 8), g8: calcCost(6, 8), h8: calcCost(6, 8), i8: calcCost(6, 8), k8: calcCost(6, 8), l8: calcCost(6, 8), // 6->8
        a9: calcCost(6, 9), b9: calcCost(6, 9), c9: calcCost(6, 9), d9: calcCost(6, 9), e9: calcCost(6, 9), f9: calcCost(6, 9), g9: calcCost(6, 9), h9: calcCost(6, 9), i9: calcCost(6, 9), k9: calcCost(6, 9), l9: calcCost(6, 9), // 6->9
    },
    k6: {
        j5: calcCost(6, 5), k5: calcCost(6, 5), l5: calcCost(6, 5), // 6->5
        j6: calcCost(6, 6), k6: calcCost(6, 6), l6: calcCost(6, 6), // 6->6 
    ...
    l6: {
        a5: calcCost(6, 5), b5: calcCost(6, 5), c5: calcCost(6, 5), d5: calcCost(6, 5), e5: calcCost(6, 5), f5: calcCost(6, 5), g5: calcCost(6, 5), h5: calcCost(6, 5), i5: calcCost(6, 5), j5: calcCost(6, 5), k5: calcCost(6, 5),  // 6->5
        ...
        a7: calcCost(6, 7), b7: calcCost(6, 7), c7: calcCost(6, 7), d7: calcCost(6, 7), e7: calcCost(6, 7), f7: calcCost(6, 7), g7: calcCost(6, 7), h7: calcCost(6, 7), i7: calcCost(6, 7), j7: calcCost(6, 7), k7: calcCost(6, 7),  // 6->7         
        a8: calcCost(6, 8), b8: calcCost(6, 8), c8: calcCost(6, 8), d8: calcCost(6, 8), e8: calcCost(6, 8), f8: calcCost(6, 8), g8: calcCost(6, 8), h8: calcCost(6, 8), i8: calcCost(6, 8), j8: calcCost(6, 8), k8: calcCost(6, 8), // 6->8
        a9: calcCost(6, 9), b9: calcCost(6, 9), c9: calcCost(6, 9), d9: calcCost(6, 9), e9: calcCost(6, 9), f9: calcCost(6, 9), g9: calcCost(6, 9), h9: calcCost(6, 9), i9: calcCost(6, 9), j9: calcCost(6, 9), k9: calcCost(6, 9),  // 6->9
    },
    a7: {
    ...
    j7: {
        ...
        a6: calcCost(7, 6), b6: calcCost(7, 6), c6: calcCost(7, 6), d6: calcCost(7, 6), e6: calcCost(7, 6), f6: calcCost(7, 6), g6: calcCost(7, 6), h6: calcCost(7, 6), i6: calcCost(7, 6), k6: calcCost(7, 6), l6: calcCost(7, 6), // 7->6 
    ...
    l7: {
        ...
        a6: calcCost(7, 6), b6: calcCost(7, 6), c6: calcCost(7, 6), d6: calcCost(7, 6), e6: calcCost(7, 6), f6: calcCost(7, 6), g6: calcCost(7, 6), h6: calcCost(7, 6), i6: calcCost(7, 6), j6: calcCost(7, 6), k6: calcCost(7, 6),  // 7->6 
